...
Game::Game() noexcept(false) : m_pTimer{new StepTimer{}}, m_pSceneManager{ EntityEngine::SceneManager::GetInstance() },m_pRenderer{ std::make_unique<Renderer>() }
{
...
void Game::Update()
{
   ...
   // EntityEngine::InputManager::GetInstance()->ProcessControllerInput(elapsedTime);
    EntityEngine::InputManager::GetInstance()->Update();
...
void Game::OnActivated()
{
    ...
    const auto inputManager{ EntityEngine::InputManager::GetInstance() };
    inputManager->Resume();
}
